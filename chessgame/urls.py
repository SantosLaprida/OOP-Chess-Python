...
from .views import home_view, initial_board, check_highlight, initial_board_fen, make_move, get_all_legal_moves, get_legal_moves
...
urlpatterns = [
    ...
    path('get-all-legal-moves/', get_all_legal_moves, name='get_all_legal_moves'),
